...
public:
	...
	virtual void DrawLineBresenham(int x0, int y0, int x1, int y1, uint32_t color) override;
	virtual void DrawLineSimple(int x0, int y0, int x1, int y1, uint32_t color) override;
