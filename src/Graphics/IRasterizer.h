...
public:
	...
	virtual void SimpleBoundaryFill(int x, int y, uint32_t fillColor, uint32_t borderColor, float progress, int step) = 0;
	virtual void DrawRectangle(int x0, int y0, int x1, int y1, uint32_t color, float progress) = 0;
};